...
public:
    ...
    void setList(RamObjectList<RamUser*> *userList, RamObjectList<RamScheduleComment*> *comments);
...
private:
     RamObjectList<RamUser*> *m_users = nullptr;
     RamObjectList<RamScheduleComment*> *m_comments = nullptr;
