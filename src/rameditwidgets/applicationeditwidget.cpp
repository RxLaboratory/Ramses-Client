...
void ApplicationEditWidget::setupUi()
{
    ...
    m_nativeList = new ObjectListEditWidget<RamFileType*>(true, RamUser::Admin);
    m_nativeList->setEditMode(ObjectListEditWidget<RamFileType*>::UnassignObjects);
    ...
    m_importList = new ObjectListEditWidget<RamFileType*>(true, RamUser::Admin);
    m_importList->setEditMode(ObjectListEditWidget<RamFileType*>::UnassignObjects);
    ...
    m_exportList = new ObjectListEditWidget<RamFileType*>(true, RamUser::Admin);
    m_exportList->setEditMode(ObjectListEditWidget<RamFileType*>::UnassignObjects);
